                ...
                <table class="w-full border-collapse bg-white">
                    <thead>
                        <tr class="bg-slate-900 text-white">
                            ...
                            {{-- KOLOM NOMOR HP --}}
                            <th class="p-5 text-left text-[10px] font-black uppercase tracking-[0.2em]">No. WhatsApp</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            {{-- MENAMPILKAN DATA NO HP --}}
                            <td class="p-5 text-sm font-bold text-blue-600 italic tracking-tight">
                                {{ $k->no_hp ?? '-' }}
                            </td>
