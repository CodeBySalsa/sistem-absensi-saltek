...
<div class="relative bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white p-4 md:p-12 rounded-[1.5rem] md:rounded-[2.5rem] shadow-xl shadow-indigo-950/10 mb-6 md:mb-10 overflow-hidden flex flex-row justify-between items-center gap-2">
    ...
    {{-- Card Pimpinan Access Control (Diberi efek hover) --}}
    <div class="relative z-10 w-7/12 transition-all duration-300 hover:scale-105 cursor-default">
...
<div class="grid grid-cols-3 gap-2 md:gap-6 mb-8 md:mb-10">
    ...
    <a href="#log-kehadiran" class="bg-emerald-50 border border-emerald-100 p-2 md:p-6 rounded-xl md:rounded-[2rem] shadow-lg shadow-emerald-200/20 flex items-center gap-1 md:gap-5 transition-all duration-300 hover:scale-105 hover:bg-emerald-100 cursor-pointer">
        <div class="text-sm md:text-2xl w-6 h-6 md:w-14 md:h-14 bg-emerald-500 text-white rounded-lg flex items-center justify-center shrink-0 shadow-md">✅</div>
        <div>
            <p class="text-[6px] md:text-[10px] font-black text-emerald-800 uppercase tracking-widest">Hadir</p>
            <h3 class="text-xs md:text-2xl font-black text-emerald-900">{{ $totalHadir }}</h3>
        </div>
    </a>

    {{-- Card Izin --}}
    <a href="#log-kehadiran" class="bg-amber-50 border border-amber-100 p-2 md:p-6 rounded-xl md:rounded-[2rem] shadow-lg shadow-amber-200/20 flex items-center gap-1 md:gap-5 transition-all duration-300 hover:scale-105 hover:bg-amber-100 cursor-pointer">
        <div class="text-sm md:text-2xl w-6 h-6 md:w-14 md:h-14 bg-amber-500 text-white rounded-lg flex items-center justify-center shrink-0 shadow-md">✋</div>
        <div>
            <p class="text-[6px] md:text-[10px] font-black text-amber-800 uppercase tracking-widest">Izin</p>
            <h3 class="text-xs md:text-2xl font-black text-amber-900">{{ $totalIzin }}</h3>
        </div>
    </a>

    {{-- Card Sakit --}}
    <a href="#log-kehadiran" class="bg-rose-50 border border-rose-100 p-2 md:p-6 rounded-xl md:rounded-[2rem] shadow-lg shadow-rose-200/20 flex items-center gap-1 md:gap-5 transition-all duration-300 hover:scale-105 hover:bg-rose-100 cursor-pointer">
        <div class="text-sm md:text-2xl w-6 h-6 md:w-14 md:h-14 bg-rose-500 text-white rounded-lg flex items-center justify-center shrink-0 shadow-md">🤒</div>
        <div>
            <p class="text-[6px] md:text-[10px] font-black text-rose-800 uppercase tracking-widest">Sakit</p>
