...
<head>
    ...
    <title>Absensi Digital - PT Saltek</title>
        ...
        <div class="relative z-10 w-full max-w-md">
            <div class="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(8,112,184,0.12)] border border-blue-50/50 p-10 text-center">
                ...
                <p class="mt-4 text-slate-500 text-sm font-medium leading-relaxed">
                    Sistem Monitoring Absensi Karyawan & <br>Mahasiswa KKN Universitas Harapan Medan.
                </p>

                <div class="mt-10 space-y-4">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="flex items-center justify-center w-full bg-slate-900 hover:bg-black text-white font-bold py-4 rounded-2xl transition-all active:scale-95">
                                MASUK KE DASHBOARD
                            </a>
                        @else
